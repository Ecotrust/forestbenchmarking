...
def main():
    ...
    gfl_path = create_directory_tree(root, 'data/raw/forest_benchmarking', 'GFLandsat_V2')
    ...
    #         future_url = {executor.submit(download_gflandsat_img, *p): p for p in chunk}
    ...
    with Pool(WORKERS) as pool:
        pool.starmap(download_gflandsat_img, params)
