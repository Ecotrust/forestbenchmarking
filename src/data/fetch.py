"""
Cloned from https://github.com/Ecotrust/ForestMapping/blob/master/src/data/fetch.py
"""
import numpy as np
import requests
...
def landtrendr_from_gee(bbox, year, epsg=4326, scale=30):
    ...
    """
    url, _ = get_landtrendr_download_url(bbox, year, epsg, scale)
